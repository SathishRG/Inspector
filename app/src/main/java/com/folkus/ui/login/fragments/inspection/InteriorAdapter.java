...
public class InteriorAdapter extends RecyclerView.Adapter<InteriorAdapter.RecyclerViewHolder> {

    private Context mContext;
    InspectionInteriorFragment interiorFragment;
    private ArrayList<Uri> picturesList;

    public InteriorAdapter(Context context, ArrayList<Uri> stringArrayList, InspectionInteriorFragment inspectionInteriorFragment) {
        this.mContext = context;
        this.picturesList = stringArrayList;
        this.interiorFragment = inspectionInteriorFragment;
    }

    @NonNull
    @Override
    public InteriorAdapter.RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.inspection_add_image_video_item_view, parent, false);
        return new RecyclerViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull InteriorAdapter.RecyclerViewHolder holder, int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (position == itemCount) {
                    interiorFragment.addMultipleImageAndVideos();
                }
            }
        });
