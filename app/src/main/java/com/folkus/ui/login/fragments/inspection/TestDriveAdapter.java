...
public class TestDriveAdapter extends RecyclerView.Adapter<TestDriveAdapter.RecyclerViewHolder> {

    private Context mContext;
    InspectionTestDriveFragment testDriveFragment;
    private ArrayList<Uri> picturesList;

    public TestDriveAdapter(Context context, ArrayList<Uri> stringArrayList, InspectionTestDriveFragment inspectionTestDriveFragment) {
        this.mContext = context;
        this.picturesList = stringArrayList;
        this.testDriveFragment = inspectionTestDriveFragment;
    }

    @NonNull
    @Override
    public TestDriveAdapter.RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.inspection_add_image_video_item_view, parent, false);
        return new RecyclerViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TestDriveAdapter.RecyclerViewHolder holder, int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (position == itemCount) {
                    testDriveFragment.addMultipleImageAndVideos();
                }
            }
        });
