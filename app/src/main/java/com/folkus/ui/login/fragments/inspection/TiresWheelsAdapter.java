...
public class TiresWheelsAdapter extends RecyclerView.Adapter<TiresWheelsAdapter.RecyclerViewHolder> {

    private Context mContext;
    InspectionTiresWheelsFragment tiresWheelsFragment;
    private ArrayList<Uri> picturesList;


    public TiresWheelsAdapter(Context context, ArrayList<Uri> stringArrayList, InspectionTiresWheelsFragment inspectionTiresWheelsFragment) {
        this.mContext = context;
        this.picturesList = stringArrayList;
        this.tiresWheelsFragment = inspectionTiresWheelsFragment;
    }

    @NonNull
    @Override
    public TiresWheelsAdapter.RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.inspection_add_image_video_item_view, parent, false);
        return new RecyclerViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TiresWheelsAdapter.RecyclerViewHolder holder, int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (position == itemCount) {
                    tiresWheelsFragment.addMultipleImageAndVideos();
                }
            }
        });
