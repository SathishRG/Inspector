...
public class ExteriorAdapter extends RecyclerView.Adapter<ExteriorAdapter.RecyclerViewHolder> {

    private Context mContext;
    InspectionExteriorFragment exteriorFragment;
    private ArrayList<Uri> picturesList;

    public ExteriorAdapter(Context context, ArrayList<Uri> stringArrayList, InspectionExteriorFragment inspectionExteriorFragment) {
        this.mContext = context;
        this.picturesList = stringArrayList;
        this.exteriorFragment = inspectionExteriorFragment;
    }

    @NonNull
    @Override
    public ExteriorAdapter.RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.inspection_add_image_video_item_view, parent, false);
        return new RecyclerViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ExteriorAdapter.RecyclerViewHolder holder, int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (position == itemCount) {
                    exteriorFragment.addMultipleImageAndVideos();
                }
            }
        });
